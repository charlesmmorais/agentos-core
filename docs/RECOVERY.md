...
2. Copiar o diretório de estado para um destino novo.
...
Backup precisa incluir snapshot, código, dependências Python e workspace. Os caminhos absolutos precisam ser preservados ou migrados por procedimento administrativo validado em uma máquina nova. Revalidar permissões, suspensão e recibos externos antes de executar.
